...
public class EnhancedListView extends ListView {
     ...
     * Pass this to {@link #setUndoStyle(com.ilsecondodasinistra.parakeet.EnhancedListView.UndoStyle)}
     ...
     * Use {@link #setSwipeDirection(com.ilsecondodasinistra.parakeet.EnhancedListView.SwipeDirection)}
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback)}
    ...
    public interface OnDismissCallback {
         ...
         * of {@link com.ilsecondodasinistra.parakeet.EnhancedListView.Undoable} from this method.
         ...
         *
         * @param listView The {@link com.ilsecondodasinistra.parakeet.EnhancedListView} the item has been deleted from.
         * @param position The position of the item to delete from your adapter.
         * @return An {@link com.ilsecondodasinistra.parakeet.EnhancedListView.Undoable}, if you want
     ...
     * {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback#onDismiss(com.ilsecondodasinistra.parakeet.EnhancedListView, int)}
     * to let the user undo the deletion you've done with your {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback#onDismiss(com.ilsecondodasinistra.parakeet.EnhancedListView, int)} and reinsert
         ...
         * (whereas in {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback#onKeyDown(int, android.view.KeyEvent)}
...
//        mUndoPopup.setAnimationStyle(R.style.fade_animation);
     ...
     * <i>undo</i> of the deletion, return an {@link com.ilsecondodasinistra.parakeet.EnhancedListView.Undoable}
     * from {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback#onDismiss(com.ilsecondodasinistra.parakeet.EnhancedListView, int)}.
     ...
     * @throws IllegalStateException when you haven't passed an {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback}
     *      to {@link #setDismissCallback(com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback)} before calling this
     *      method.
     */
    ...
    /**
     * Sets the undo style of this list. See the javadoc of {@link com.ilsecondodasinistra.parakeet.EnhancedListView.UndoStyle}
     * for a detailed explanation of the different styles. The default style (if you never call this
     * method) is {@link com.ilsecondodasinistra.parakeet.EnhancedListView.UndoStyle#SINGLE_POPUP}.
     *
     ...
     * By default this is set to {@link com.ilsecondodasinistra.parakeet.EnhancedListView.SwipeDirection#BOTH} so that an item
     ...
     * {@link com.ilsecondodasinistra.parakeet.EnhancedListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException when this method is called before an {@link com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback}
     *      is set via {@link #setDismissCallback(com.ilsecondodasinistra.parakeet.EnhancedListView.OnDismissCallback)}.
     * */
     ...
     * {@link #setSwipeDirection(com.ilsecondodasinistra.parakeet.EnhancedListView.SwipeDirection)}
     *
